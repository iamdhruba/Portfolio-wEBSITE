...
export default function DesktopIcon({ appId, label, onDoubleClick }: DesktopIconProps) {
  ...
  return (
    <div 
      className="flex flex-col items-center justify-start w-24 h-28 pt-2 rounded-lg cursor-pointer transition-colors pointer-events-auto hover:bg-white/10"
    ...
    >
      ...
      <span 
        className="mt-1 text-sm text-center font-medium px-1 rounded line-clamp-2 leading-tight text-white drop-shadow-md" 
